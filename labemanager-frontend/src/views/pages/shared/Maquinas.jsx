// src/pages/shared/Maquinas.jsx

import React, { useState, useEffect } from 'react';
import MainLayout from '../../components/layouts/MainLayout';
import { useAuth } from '../../../context/AuthContext';
import { machinesApi } from '../../../models/inventory';
import InventoryItemCard from '../../components/inventory/InventoryItemCard';
import InventoryForm from '../../components/inventory/InventoryForm';
import { FaPlus } from 'react-icons/fa';

const Maquinas = () => {
    const entityType = 'Máquinas';
            ...
            <div className="max-w-4xl mx-auto p-6">
                ...
                {!items.length && !loading && (
                    <div className="text-center py-10 bg-[#f7f2ea] border-2 border-dashed border-gray-400 rounded-xl">
                        <p className="text-gray-500 font-medium">Nenhuma máquina encontrada.</p>
                    </div>
                )}
            </div>
        </MainLayout>
